...
class RectanglePainter extends CustomPainter {
  ...
  final double selectionOffsetLength = 1.0;
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final selectionOffset = isSelected ? selectionOffsetLength : -selectionOffsetLength;

    final offset = Offset(
      effectiveRect.left + (effectiveRect.width - textPainter.width) / 2 + selectionOffset,
      effectiveRect.top + (effectiveRect.height - textPainter.height) / 2 + selectionOffset,
    );
